...
# nn_bundle = joblib.load("D:/Lab/Model/nn_2025_07_11_12_09_17.pkl")
# preprocess_bundle = joblib.load("D:/Lab/Model/preprocessing_bundle_2025_07_11_12_07_39.pkl")
...
with right_col:
    ...
    # 1. Prepare FOS summary dictionary
    fos_summary = {
        "Parameter": [
    ...
    # 3. Convert DataFrame to Excel in memory
    excel_buffer = io.BytesIO()
    with pd.ExcelWriter(excel_buffer, engine='xlsxwriter') as writer:
        fos_df.to_excel(writer, index=False, sheet_name='FOS_Summary')
    
    excel_buffer.seek(0)  # Reset buffer position
    
    # 4. Download button
    st.download_button(
        label="Download FOS Summary (Excel)",
        data=excel_buffer,
        file_name="FOS_Summary.xlsx",
